(function (game) {
  ...
  const dom = {
    ...
    heldBarEl: document.getElementById('heldBar'),
    heldBarIconEl: document.querySelector('#heldBar .held-bar-icon'),
    heldBarNameEl: document.querySelector('#heldBar .held-bar-name'),
    heldBarMetaEl: document.querySelector('#heldBar .held-bar-meta'),
    ...
    itemMenuDescEl: document.getElementById('itemMenuDesc'),
